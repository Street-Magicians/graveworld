  ...
  return (
    <main className="column">
      ...
      <figure className="columns is-centered is-mobile  ">
        <img src={require("../assets/images/sprites/ghost1.gif")} alt="an 8-bit rendering of a brown ghost" className="column is-one-third-mobile is-one-fifth-tablet is-one-fifth-desktop" />
      </figure>
